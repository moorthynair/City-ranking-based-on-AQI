...
##User Defined Inputs
date = input('Enter the date of analysis in the format YYYYMMDD: ') ## Make sure you call dates between 15th August 2015 to 28th January 2018 (20150815 - 20180128)
...
############################# Analysis Begins ################################################
## date call check
if (date<'20150815') & (date>'20180128'):
...
final_file.drop(columns=['index'], inplace=True)

## Step 5: Assing the rank based on AQI values
final_file['ranking'] = np.arange(1, len(final_file)+1)
final_file['Based on number of']= final_file['Based on number of'].astype('int')
